...
function getYearlyReport(obj)
{
    ...
    var url = APP_URL+"/fm_claimMileageReport/yearlyReport";
...
<!--console.error(_obj);-->
    <!--                alert(_obj.name +' '+ _obj.total);-->
                ...
                $('#table_title').html("Tuntutan Perjalanan Tahun "+ obj.year);
...
function getMonthlyReport(obj)
{
    $('#errMsg').hide();    <!--  hide #errMsg -->
    $('#row_tbl_month_report').hide();
    var url = APP_URL+"/fm_claimMileageReport/monthlyReport";
    var inputData = JSON.stringify(obj);
    var type = "POST";
...
<!--console.error(_obj);-->
    <!--                alert(_obj.name +' '+ _obj.total);-->
                ...
                $('#table_title').html("Tuntutan Perjalanan Bulan "+ obj.month_name + " " + obj.year);
...
function getStaffReport(obj)
{
    $('#errMsg').hide();    <!--  hide #errMsg -->
    $('#row_tbl_month_report').hide();
    var url = APP_URL+"/fm_claimMileageReport/staffReport";
    var inputData = JSON.stringify(obj);
    var type = "POST";
...
function getSupervisorStaffReport(obj)
{
    $('#errMsg').hide();    <!--  hide #errMsg -->
    $('#row_tbl_month_report').hide();
    var url = APP_URL+"/fm_claimMileageReport/sv_staffReport";
    var inputData = JSON.stringify(obj);
    var type = "POST";
...
<!--                    alert(_obj.name +' '+ _obj.total);-->
                ...
                $('#table_title').html("Tuntutan Perjalanan "+obj.month_name+" "+ obj.year +" bagi supervisee " + obj.sv_name);
    ...
    <script type="text/javascript">
       ...
       function drawChartYearly(arr_obj,year)
       {
           ...
           function drawChart2() {
               ...
               var options = {
                   title: "Tuntutan Perjalanan Tahun "+ year,
                   width: 600,
                   height: 400,
                   bar: {groupWidth: "95%"},
...
//               ]);
       ...
       function drawChartMontlySV_Staff(arr_obj,sv,year,month)
       {
           ...
           function drawChart2() {
               ...
               var options = {
                   title: "Tuntutan Perjalanan " + " "+ month + " " +year +" bagi Supervisee "+ sv,
                   width: 600,
                   height: 400,
                   bar: {groupWidth: "95%"},
                   legend: { position: "none" },
