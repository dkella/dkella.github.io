...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-11 col-md-11 col-sm-11">
            <h1>Tuntutan Perjalanan</h1>
        </div>
        <div class="col-lg-1 col-md-1 col-sm-1">
            <button onclick="window.location='{{ url('/claimMileage/create')}}';">
...
<!--                                1-draft             4- sv reject        7- fm reject-->
                @if($claim->status==1)
                <td><a href="{{ url('/claimMileage',$claim->id)}}">
                        <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                    </a></td>
                <!--                                4- sv reject    6-pending-->
                @elseif($claim->status==4 || $claim->status==6)
                <td><a href="{{ url('/claimMileage/correction',$claim->id)}}">
                        <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                    </a></td>
                ...
                <td><a href="{{ url('/claimMileage/print',$claim->id)}}" class="print_claim">
                        <span class="glyphicon glyphicon-print" aria-hidden="true"></span>
                    </a></td>
<!--                                1-draft             4- sv reject        7- fm reject-->
                @if($claim->status==1)
                <td><a href="{{ url('/claimMileage/delete',$claim->id)}}" class="delete_record">
    ...
    @else
        <p>Tiada rekod.<a href="{{ url('/claimMileage/create')}}">Tambah rekod</a> </p>
    @endif
