...
<!--                <li><a href="/vehicle">Kenderaan</a></li>-->
                <li class="dropdown">
                    <a href="#">Kelulusan Tuntutan<span class="caret"></span></a>
                    <div class="dropdown-content">
                        <a href="{{ url('/claimMileageApproval') }}">Kelulusan Tuntutan Perjalanan</a>
                        <a href="{{ url('/claimOvertimeApproval') }}">Kelulusan Tuntutan Overtime</a>
                    </div>
                </li>
                <li class="dropdown">
