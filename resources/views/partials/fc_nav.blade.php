    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
            <ul class="nav navbar-nav">
                ...
                <li><a href="{{ url('/staffProfile') }}">Senarai Staff</a></li>
...
<!--                <li class="dropdown">-->
<!--                    <a href="#">Senarai Tuntutan<span class="caret"></span></a>-->
<!--                    <div class="dropdown-content">-->
<!--                        <a href="#">Senarai Tuntutan Perjalanan</a>-->
<!--                        <a href="#">Senarai Tuntutan Overtime</a>-->
<!--                    </div>-->
<!--                </li>-->
                    <li><a href="{{ url('/staffSalary') }}">Bayaran Gaji</a></li>


<!--                <li class="dropdown">-->
<!--                    <a href="#">Laporan Tuntutan<span class="caret"></span></a>-->
<!--                    <div class="dropdown-content">-->
<!--                        <a href="#">Laporan Tuntutan Perjalanan</a>-->
<!--                        <a href="#">Laporan Tuntutan Overtime</a>-->
<!--                    </div>-->
<!--                </li>-->
