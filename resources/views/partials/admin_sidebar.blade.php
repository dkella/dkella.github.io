...
<!--            <li><a href="/personal">&nbsp; Maklumat Peribadi</a></li>-->
    ...
    <li><a href="{{ url('/staffList') }}"><span class="glyphicon glyphicon-list-alt pull-left">&nbsp;</span>Senarai Pengguna</a></li>
<!--    <li><a href="#"><span class="glyphicon glyphicon-edit pull-left">&nbsp;</span>Page Configuration</a></li>-->
...
<!--            <li><a href="/claimMileageVerify">&nbsp; Pengesahan Tuntutan Perjalanan</a></li>-->
<!--            <li><a href="/claimOvertimeVerify">&nbsp; Pengesahan Tuntutan Overtime</a></li>-->
<!--        </ul>-->
<!--    </li>-->
    <li>
        ...
        <ul id="report_claim_nav" class="nav collapse">
            <li><a href="{{ url('/fm_claimMileageReport') }}">&nbsp; Laporan Tuntutan Perjalanan</a></li>
            <li><a href="{{ url('/fm_claimOvertimeReport') }}">&nbsp; Laporan Tuntutan Overtime</a></li>
        </ul>
    </li>
</ul>
