...
<!--                        <a href="/personal">Maklumat Peribadi</a>-->
                        <a href="{{ url('/password') }}">Tukar kata laluan</a>
                    </div>
                </li>
                <li><a href="{{ url('/staffList') }}">Senarai Pengguna</a></li>
<!--                <li><a href="#">Page Configuration</a></li>-->
<!--                <li><a href="/supervisee">Supervisee</a></li>-->
<!--                <li class="dropdown">-->
...
<!--                    <div class="dropdown-content">-->
<!--                        <a href="/claimMileageVerify">Pengesahan Tuntutan Perjalanan</a>-->
<!--                        <a href="/claimOvertimeVerify">Pengesahan Tuntutan Overtime</a>-->
<!--                    </div>-->
<!--                </li>-->
                <li class="dropdown">
                    <a href="#">Laporan Tuntutan<span class="caret"></span></a>
                    <div class="dropdown-content">
                        <a href="{{ url('/fm_claimMileageReport') }}">Laporan Tuntutan Perjalanan</a>
                        <a href="{{ url('/fm_claimOvertimeReport') }}">Laporan Tuntutan Overtime</a>
                    </div>
                </li>
