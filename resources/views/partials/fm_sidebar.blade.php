...
<!--    <li><a href="/vehicle"><span class="glyphicon glyphicon-road pull-left">&nbsp;</span>Kenderaan</a></li>-->
    <li>
        <a class="dropdown-collapse" href="#" data-toggle="collapse" data-target="#approve_claim_nav" >
            <span class="glyphicon glyphicon-saved pull-left">&nbsp;</span>
            Kelulusan Tuntutan
            <span class="glyphicon glyphicon-menu-down pull-right"></span>
        </a>
        <ul id="approve_claim_nav" class="nav collapse">
            <li><a href="{{ url('/claimMileageApproval') }}">&nbsp; Kelulusan Tuntutan Perjalanan</a></li>
            <li><a href="{{ url('/claimOvertimeApproval') }}">&nbsp; Kelulusan Tuntutan Overtime</a></li>
        </ul>
    </li>
    <li>
