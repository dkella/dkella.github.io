...
<div class="well bs-component" style="text-align: center;">
    <form class="form-horizontal">
        <fieldset>
            ...
            <div class="claim_form">
                <table style=" width: 100%; border-right:0px; border-bottom:0px;" class="table table-bordered" id="claim_table" claim_id="{{ $claims->id }}">
                    <thead>
                    <tr>
                    ...
                    @foreach($claims->otclaim as $claim)
                        <tr isHoliday="{{ $claim->isHoliday }}">
                            ...
                            <td style="border:0px;"><a href="#" class="edit_modal">
