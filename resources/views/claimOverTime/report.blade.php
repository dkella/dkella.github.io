...
<div class="row">
    <div class="col-lg-11 col-md-11 col-sm-11">
        <h1>Laporan Tuntutan Kerja Lebih Masa</h1>
    </div>
</div>
...
function getMonthlyReport(obj)
{
    ...
    var url = APP_URL+"/claimOvertimeReport/monthlyReport";
...
<!--        async: false,  //wait this done runs-->
    ...
    <!--                alert(_obj.name +' '+ _obj.total);-->
                ...
                $('#table_title').html("Tuntutan Kerja Lebih Masa "+ obj.month_name + " " + obj.year);
...
function getStaffReport(obj)
{
    $('#errMsg').hide();    <!--  hide #errMsg -->
    $('#row_tbl_month_report').hide();
    var url = APP_URL+"/claimOvertimeReport/staffReport";
    var inputData = JSON.stringify(obj);
    var type = "POST";
